...
saved_csv="var_2.csv"       #load the matrix as a previously saved .csv
savefig="TrajMap_var_2.png"		#savename of the heatmap
title="Variant 2 simulation"			#title of the map
