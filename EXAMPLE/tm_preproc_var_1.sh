...
topology="variant_1.pdb"      #your topology file (gro, pdb, prmtop...)
trajectories="variant_1.pdb"  #your trajectory file (xtc, nc)
stride="1"			     #trajectory reading stride
saved_pdb="var_1.pdb"	     #name of the created pdb
saved_csv="var_1.csv"            #name of the created .csv matrix
